...
const CompletedTask = ({ data }) => {
  return (
    <div className="ems-task-card ems-task-card--completed ems-animate-in">
      <div className="ems-task-card__top">
        <span className="ems-task-card__badge ems-task-card__badge--completed">
          <span className="ems-task-card__badge-dot"></span> Completed
        </span>
      ...
      <div className="ems-task-card__actions">
        <div className="ems-task-status-pill ems-task-status-pill--success">
