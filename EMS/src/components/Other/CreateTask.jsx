...
const CreateTask = () => {
  ...
  const submitHandler = (e)=>{
    ...
    console.log(taskTitle,taskDescription ,category, asignTo , taskDate,   )
  }
  return (
    <div className='p-5 bg-[#1c1c1c] mt-7 rounded '>
            <form  onSubmit={(e)=>{
              ...
              <input
                ...
                className='text-sm py-1 px-2 w-4/5  rounded outline-none bg-transparent border-[1px] border-gray-400 mb-4' type="date" name="" id="" /></div>
